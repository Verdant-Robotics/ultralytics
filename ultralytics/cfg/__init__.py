...
TASKS = 'detect', 'segment', 'classify', 'pose', 'pose-contrastive', 'pose-multiclsheads', 'pose-field'
...
TASK2MODEL = {
    ...
    'post-field':'yolov8n-pose-field.pt'}
TASK2METRIC = {
